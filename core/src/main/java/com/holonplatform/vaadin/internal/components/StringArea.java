 ...
 * @since 5.0.0
 */
public class StringArea extends TextArea implements Input<String>, Field<String> {
	...
	public static class Builder extends AbstractStringFieldBuilder<StringArea> {
		 ...
		 */
		@Override
		protected Input<String> build(StringArea instance) {
			return instance;
		}
		 ...
		 */
		@Override
		protected Field<String> buildAsField(StringArea instance) {
			return instance;
		}
