 ...
 * @since 5.0.0
 */
public interface BaseSelectModeSinglePropertySelectInputBuilder<T, B extends BaseSelectModeSinglePropertySelectInputBuilder<T, B>>
		extends SinglePropertySelectInputBuilder<T, B> {
	...
	/**
	 * A {@link SinglePropertySelectInputBuilder} for {@link RenderingMode#NATIVE_SELECT}.
	 * 
	 * @param <T> Value type
	 */
	public interface NativeModeSinglePropertySelectInputBuilder<T>
			extends BaseSelectModeSinglePropertySelectInputBuilder<T, NativeModeSinglePropertySelectInputBuilder<T>> {

	}

	/**
	 * A {@link SinglePropertySelectInputBuilder} for {@link RenderingMode#OPTIONS}.
	 * 
	 * @param <T> Value type
	 */
	public interface OptionsModeSinglePropertySelectInputBuilder<T>
			extends SinglePropertySelectInputBuilder<T, OptionsModeSinglePropertySelectInputBuilder<T>> {
		 ...
		 * @return this
		 */
		OptionsModeSinglePropertySelectInputBuilder<T> htmlContentAllowed(boolean htmlContentAllowed);
	...
	/**
	 * A {@link SinglePropertySelectInputBuilder} for {@link RenderingMode#SELECT}.
	 * 
	 * @param <T> Value type
	 */
	public interface SelectModeSinglePropertySelectInputBuilder<T>
			extends BaseSelectModeSinglePropertySelectInputBuilder<T, SelectModeSinglePropertySelectInputBuilder<T>> {
		 ...
		 * @return this
		 */
		default SelectModeSinglePropertySelectInputBuilder<T> inputPrompt(String inputPrompt) {
		 ...
		 * @return this
		 */
		default SelectModeSinglePropertySelectInputBuilder<T> inputPrompt(String defaultInputPrompt, String messageCode,
				Object... arguments) {
		 ...
		 * @return this
		 */
		SelectModeSinglePropertySelectInputBuilder<T> inputPrompt(Localizable inputPrompt);
		 ...
		 * @return this
		 */
		SelectModeSinglePropertySelectInputBuilder<T> disableTextInput();
		 ...
		 * @return this
		 */
		SelectModeSinglePropertySelectInputBuilder<T> scrollToSelectedItem(boolean scrollToSelectedItem);
		 ...
		 * @return this
		 */
		SelectModeSinglePropertySelectInputBuilder<T> suggestionPopupWidth(String width);
		 ...
		 * @return this
		 */
		SelectModeSinglePropertySelectInputBuilder<T> captionQueryFilter(
