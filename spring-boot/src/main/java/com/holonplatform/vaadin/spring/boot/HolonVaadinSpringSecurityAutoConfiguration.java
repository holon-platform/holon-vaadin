...
public class HolonVaadinSpringSecurityAutoConfiguration {
	...
	@Configuration
	@EnableSecuredView
	static class EnableSecuredViewConfiguration implements InitializingBean {
		@Override
		public void afterPropertiesSet() throws Exception {
			LOGGER.debug(() -> EnableSecuredViewConfiguration.class.getName() + " initialized");
		}
	}
