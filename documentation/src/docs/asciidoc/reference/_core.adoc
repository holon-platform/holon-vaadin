...
By default, the cells of a column bound to a `Property` are _rendered_ using the Holon Platform property value _presenters_ available from the default registry, to provide the String representation of the cell value. 
